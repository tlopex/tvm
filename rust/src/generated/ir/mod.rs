...
impl DictAttrs {
    ...
    pub fn new(__dict__: Map<String, ObjectRef>) -> Self {
        Self {
...
impl IRModule {
    ...
    pub fn new(functions: Map<GlobalVar, BaseFunc>, source_map: SourceMap, attrs: DictAttrs, global_infos: Map<String, Array<GlobalInfo>>, global_var_map_: Map<String, GlobalVar>) -> Self {
        Self {
...
impl Op {
    ...
    pub fn new(span: Span, ty: Type, name: String, description: String, arguments: Array<ArgumentInfo>, attrs_type_key: String, num_inputs: i64, support_level: i64) -> Result<Op> {
...
impl Range {
    ...
    pub fn new(min: Expr, extent: Expr, span: Span) -> Self {
        Self {
...
impl Source {
    ...
    pub fn new(source_name: SourceName, source: String) -> Self {
        Self {
...
impl SourceMap {
    ...
    pub fn new(source_map: Map<SourceName, Source>) -> Self {
        Self {
...
impl Span {
    ...
    pub fn new(source_name: SourceName, line: i32, column: i32, end_line: i32, end_column: i32) -> Self {
        Self {
...
impl SequentialSpan {
    ...
    pub fn new(source_name: SourceName, line: i32, column: i32, end_line: i32, end_column: i32, spans: Array<Span>) -> Self {
        Self {
...
impl UniqueNameSupply {
    ...
    pub fn new() -> Self {
        Self {
            data: ObjectArc::new(UniqueNameSupplyObj {
                base: Object::new(),
            }),
        }
    }
