...
impl Buffer {
    ...
    pub fn new(data: Var, dtype: PrimType, shape: Array<Expr>, axis_separators: Array<IntImm>, strides: Array<Expr>, elem_offset: Expr, name: String, data_alignment: i32, offset_factor: i32, buffer_type: i32, span: Span, layout: Optional<Layout>, allocated_addr: Array<Expr>) -> Self {
        Self {
...
impl CommReducer {
    ...
    pub fn new(lhs: Array<Var>, rhs: Array<Var>, result: Array<Expr>, identity_element: Array<Expr>, span: Span) -> Self {
        Self {
...
impl DispatchContext {
    ...
    pub fn new(target: Target, exec_scope: ExecScope, launch_params: Map<String, IterVar>, var_range_map: Map<Var, Range>, alloc_only: bool, callbacks: Map<String, ObjectRef>, shared_state: Map<String, ObjectRef>, inter: Map<String, Array<Expr>>, intra: Map<String, Array<Expr>>, scope_kind: String) -> Self {
        Self {
...
impl IndexMap {
    ...
    pub fn new(initial_indices: Array<Var>, final_indices: Array<Expr>, inverse_index_map: Optional<ObjectRef>) -> Self {
        Self {
...
impl Iter {
    ...
    pub fn new(extent: Expr, stride: Expr, axis: Axis) -> Self {
        Self {
...
impl MatchBufferRegion {
    ...
    pub fn new(buffer: Buffer, source: BufferRegion) -> Self {
        Self {
...
impl Pipeline {
    ...
    pub fn new(thread_scope: ExecScope, depth: i64, separate_pc: bool, name_hint: String, workspace: Map<String, Buffer>, schedule_config: Map<String, ObjectRef>) -> Self {
        Self {
...
impl Predicate {
    ...
    pub fn new(vars: Array<Var>, pred: Expr) -> Self {
        Self {
...
impl PyStmtExprMutator {
    ...
    pub fn new() -> Self {
        Self {
            data: ObjectArc::new(PyStmtExprMutatorObj {
                base: Object::new(),
            }),
        }
    }
...
impl PyStmtExprVisitor {
    ...
    pub fn new() -> Self {
        Self {
            data: ObjectArc::new(PyStmtExprVisitorObj {
                base: Object::new(),
            }),
        }
    }
...
impl ScopeIdDef {
    ...
    pub fn new(def_ids: Array<Var>, extents: Optional<Array<Expr>>, scope: i32, preferred_extents: Optional<Array<Expr>>) -> Self {
        Self {
...
impl AllocBuffer {
    ...
    pub fn new(span: Span, buffer: Buffer, annotations: Map<String, ObjectRef>) -> Self {
        Self {
...
impl AssertStmt {
    ...
    pub fn new(span: Span, condition: Expr, error_kind: StringImm, message_parts: Array<StringImm>) -> Self {
        Self {
...
impl AttrStmt {
    ...
    pub fn new(span: Span, node: Any, attr_key: String, value: Expr, body: Stmt) -> Self {
        Self {
...
impl Bind {
    ...
    pub fn new(span: Span, var: Var, value: Expr) -> Self {
        Self {
...
impl BufferStore {
    ...
    pub fn new(span: Span, buffer: Buffer, value: Expr, indices: Array<Expr>, predicate: Optional<Expr>) -> Self {
        Self {
...
impl DeclBuffer {
    ...
    pub fn new(span: Span, buffer: Buffer) -> Self {
        Self {
...
impl Evaluate {
    ...
    pub fn new(span: Span, value: Expr) -> Self {
        Self {
...
impl For {
    ...
    pub fn new(span: Span, loop_var: Var, min: Expr, extent: Expr, kind: i32, body: Stmt, thread_binding: Optional<IterVar>, annotations: Map<String, ObjectRef>, step: Optional<Expr>) -> Self {
        Self {
...
impl IfThenElse {
    ...
    pub fn new(span: Span, condition: Expr, then_case: Stmt, else_case: Optional<Stmt>) -> Self {
        Self {
...
impl SBlock {
    ...
    pub fn new(span: Span, iter_vars: Array<IterVar>, reads: Array<BufferRegion>, writes: Array<BufferRegion>, name_hint: String, alloc_buffers: Array<Buffer>, match_buffers: Array<MatchBufferRegion>, annotations: Map<String, ObjectRef>, init: Optional<Stmt>, body: Stmt) -> Self {
        Self {
...
impl SBlockRealize {
    ...
    pub fn new(span: Span, iter_values: Array<Expr>, predicate: Expr, block: SBlock) -> Self {
        Self {
...
impl ScopeIdDefStmt {
    ...
    pub fn new(span: Span, def: ScopeIdDef) -> Self {
        Self {
...
impl SeqStmt {
    ...
    pub fn new(span: Span, seq: Array<Stmt>) -> Self {
        Self {
...
impl TensorIntrin {
    ...
    pub fn new(desc: PrimFunc, r#impl: PrimFunc) -> Self {
        Self {
...
impl While {
    ...
    pub fn new(span: Span, condition: Expr, body: Stmt) -> Self {
        Self {
