    ...
    foreach(__flag IN ITEMS ${__llvm_system_libs})
      ...
      elseif("${__flag}" STREQUAL "-lxml2")
        if (CMAKE_SYSTEM_NAME STREQUAL "Linux")
          # TVM does not use libxml2; skip it on Linux so the unused dependency
          # is not over-linked and vendored into the manylinux wheel.
          message(STATUS "Skipping unused system lib xml2 on Linux")
        else()
