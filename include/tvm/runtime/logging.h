...
/*
 * Backward-compatible check adapters.
 *
 * This branch still contains a mix of old/new check call styles:
 * - TVM_FFI_CHECK(cond)
 * - TVM_FFI_CHECK(cond, ErrorKind)
 * - TVM_FFI_CHECK_EQ(x, y)
 * - TVM_FFI_CHECK_EQ(x, y, ErrorKind)
 *
 * tvm-ffi currently requires explicit ErrorKind for TVM_FFI_CHECK*.
 * Provide local dispatch wrappers and legacy CHECK/ICHECK aliases to keep
 * existing callsites building while preserving InternalError default behavior.
 */
#define TVM_FFI_CHECK_IMPL(cond, ErrorKind) \
  if (!(cond)) TVM_FFI_THROW(ErrorKind) << "Check failed: (" #cond << ") is false: "
#define TVM_FFI_CHECK_LT_IMPL(x, y, ErrorKind) TVM_FFI_CHECK_BINARY_OP(_LT, <, x, y, ErrorKind)
#define TVM_FFI_CHECK_GT_IMPL(x, y, ErrorKind) TVM_FFI_CHECK_BINARY_OP(_GT, >, x, y, ErrorKind)
#define TVM_FFI_CHECK_LE_IMPL(x, y, ErrorKind) TVM_FFI_CHECK_BINARY_OP(_LE, <=, x, y, ErrorKind)
#define TVM_FFI_CHECK_GE_IMPL(x, y, ErrorKind) TVM_FFI_CHECK_BINARY_OP(_GE, >=, x, y, ErrorKind)
#define TVM_FFI_CHECK_EQ_IMPL(x, y, ErrorKind) TVM_FFI_CHECK_BINARY_OP(_EQ, ==, x, y, ErrorKind)
#define TVM_FFI_CHECK_NE_IMPL(x, y, ErrorKind) TVM_FFI_CHECK_BINARY_OP(_NE, !=, x, y, ErrorKind)
#define TVM_FFI_CHECK_NOTNULL_IMPL(x, ErrorKind)                              \
  ((x) == nullptr ? TVM_FFI_THROW(ErrorKind) << "Check not null: " #x << ' ', \
   (x)            : (x))  // NOLINT(*)

#undef TVM_FFI_CHECK
#undef TVM_FFI_CHECK_LT
#undef TVM_FFI_CHECK_GT
#undef TVM_FFI_CHECK_LE
#undef TVM_FFI_CHECK_GE
#undef TVM_FFI_CHECK_EQ
#undef TVM_FFI_CHECK_NE
#undef TVM_FFI_CHECK_NOTNULL

#define TVM_FFI_CHECK_SELECT_2(_1, _2, NAME, ...) NAME
#define TVM_FFI_CHECK_SELECT_3(_1, _2, _3, NAME, ...) NAME

#define TVM_FFI_CHECK_1(cond) TVM_FFI_CHECK_IMPL(cond, InternalError)
#define TVM_FFI_CHECK_2(cond, ErrorKind) TVM_FFI_CHECK_IMPL(cond, ErrorKind)
#define TVM_FFI_CHECK(...) \
  TVM_FFI_CHECK_SELECT_2(__VA_ARGS__, TVM_FFI_CHECK_2, TVM_FFI_CHECK_1)(__VA_ARGS__)

#define TVM_FFI_CHECK_LT_2(x, y) TVM_FFI_CHECK_LT_IMPL(x, y, InternalError)
#define TVM_FFI_CHECK_LT_3(x, y, ErrorKind) TVM_FFI_CHECK_LT_IMPL(x, y, ErrorKind)
#define TVM_FFI_CHECK_LT(...) \
  TVM_FFI_CHECK_SELECT_3(__VA_ARGS__, TVM_FFI_CHECK_LT_3, TVM_FFI_CHECK_LT_2)(__VA_ARGS__)

#define TVM_FFI_CHECK_GT_2(x, y) TVM_FFI_CHECK_GT_IMPL(x, y, InternalError)
#define TVM_FFI_CHECK_GT_3(x, y, ErrorKind) TVM_FFI_CHECK_GT_IMPL(x, y, ErrorKind)
#define TVM_FFI_CHECK_GT(...) \
  TVM_FFI_CHECK_SELECT_3(__VA_ARGS__, TVM_FFI_CHECK_GT_3, TVM_FFI_CHECK_GT_2)(__VA_ARGS__)

#define TVM_FFI_CHECK_LE_2(x, y) TVM_FFI_CHECK_LE_IMPL(x, y, InternalError)
#define TVM_FFI_CHECK_LE_3(x, y, ErrorKind) TVM_FFI_CHECK_LE_IMPL(x, y, ErrorKind)
#define TVM_FFI_CHECK_LE(...) \
  TVM_FFI_CHECK_SELECT_3(__VA_ARGS__, TVM_FFI_CHECK_LE_3, TVM_FFI_CHECK_LE_2)(__VA_ARGS__)

#define TVM_FFI_CHECK_GE_2(x, y) TVM_FFI_CHECK_GE_IMPL(x, y, InternalError)
#define TVM_FFI_CHECK_GE_3(x, y, ErrorKind) TVM_FFI_CHECK_GE_IMPL(x, y, ErrorKind)
#define TVM_FFI_CHECK_GE(...) \
  TVM_FFI_CHECK_SELECT_3(__VA_ARGS__, TVM_FFI_CHECK_GE_3, TVM_FFI_CHECK_GE_2)(__VA_ARGS__)

#define TVM_FFI_CHECK_EQ_2(x, y) TVM_FFI_CHECK_EQ_IMPL(x, y, InternalError)
#define TVM_FFI_CHECK_EQ_3(x, y, ErrorKind) TVM_FFI_CHECK_EQ_IMPL(x, y, ErrorKind)
#define TVM_FFI_CHECK_EQ(...) \
  TVM_FFI_CHECK_SELECT_3(__VA_ARGS__, TVM_FFI_CHECK_EQ_3, TVM_FFI_CHECK_EQ_2)(__VA_ARGS__)

#define TVM_FFI_CHECK_NE_2(x, y) TVM_FFI_CHECK_NE_IMPL(x, y, InternalError)
#define TVM_FFI_CHECK_NE_3(x, y, ErrorKind) TVM_FFI_CHECK_NE_IMPL(x, y, ErrorKind)
#define TVM_FFI_CHECK_NE(...) \
  TVM_FFI_CHECK_SELECT_3(__VA_ARGS__, TVM_FFI_CHECK_NE_3, TVM_FFI_CHECK_NE_2)(__VA_ARGS__)

#define TVM_FFI_CHECK_NOTNULL_1(x) TVM_FFI_CHECK_NOTNULL_IMPL(x, InternalError)
#define TVM_FFI_CHECK_NOTNULL_2(x, ErrorKind) TVM_FFI_CHECK_NOTNULL_IMPL(x, ErrorKind)
#define TVM_FFI_CHECK_NOTNULL(...) \
  TVM_FFI_CHECK_SELECT_2(__VA_ARGS__, TVM_FFI_CHECK_NOTNULL_2, TVM_FFI_CHECK_NOTNULL_1)(__VA_ARGS__)

#ifndef CHECK
#define CHECK(x) TVM_FFI_CHECK_IMPL(x, InternalError)
#define CHECK_LT(x, y) TVM_FFI_CHECK_LT_IMPL(x, y, InternalError)
#define CHECK_GT(x, y) TVM_FFI_CHECK_GT_IMPL(x, y, InternalError)
#define CHECK_LE(x, y) TVM_FFI_CHECK_LE_IMPL(x, y, InternalError)
#define CHECK_GE(x, y) TVM_FFI_CHECK_GE_IMPL(x, y, InternalError)
#define CHECK_EQ(x, y) TVM_FFI_CHECK_EQ_IMPL(x, y, InternalError)
#define CHECK_NE(x, y) TVM_FFI_CHECK_NE_IMPL(x, y, InternalError)
#define CHECK_NOTNULL(x) TVM_FFI_CHECK_NOTNULL_IMPL(x, InternalError)
#endif

#ifndef ICHECK
#define ICHECK(x) TVM_FFI_CHECK_IMPL(x, InternalError)
#define ICHECK_LT(x, y) TVM_FFI_CHECK_LT_IMPL(x, y, InternalError)
#define ICHECK_GT(x, y) TVM_FFI_CHECK_GT_IMPL(x, y, InternalError)
#define ICHECK_LE(x, y) TVM_FFI_CHECK_LE_IMPL(x, y, InternalError)
#define ICHECK_GE(x, y) TVM_FFI_CHECK_GE_IMPL(x, y, InternalError)
#define ICHECK_EQ(x, y) TVM_FFI_CHECK_EQ_IMPL(x, y, InternalError)
#define ICHECK_NE(x, y) TVM_FFI_CHECK_NE_IMPL(x, y, InternalError)
#define ICHECK_NOTNULL(x) TVM_FFI_CHECK_NOTNULL_IMPL(x, InternalError)
#endif

#ifndef DCHECK
#ifndef NDEBUG
#define DCHECK(x) TVM_FFI_CHECK_IMPL(x, InternalError)
#define DCHECK_LT(x, y) TVM_FFI_CHECK_LT_IMPL(x, y, InternalError)
#define DCHECK_GT(x, y) TVM_FFI_CHECK_GT_IMPL(x, y, InternalError)
#define DCHECK_LE(x, y) TVM_FFI_CHECK_LE_IMPL(x, y, InternalError)
#define DCHECK_GE(x, y) TVM_FFI_CHECK_GE_IMPL(x, y, InternalError)
#define DCHECK_EQ(x, y) TVM_FFI_CHECK_EQ_IMPL(x, y, InternalError)
#define DCHECK_NE(x, y) TVM_FFI_CHECK_NE_IMPL(x, y, InternalError)
#define DCHECK_NOTNULL(x) TVM_FFI_CHECK_NOTNULL_IMPL(x, InternalError)
#else
#define DCHECK(x) \
  while (false) TVM_FFI_CHECK_IMPL(x, InternalError)
#define DCHECK_LT(x, y) \
  while (false) TVM_FFI_CHECK_LT_IMPL(x, y, InternalError)
#define DCHECK_GT(x, y) \
  while (false) TVM_FFI_CHECK_GT_IMPL(x, y, InternalError)
#define DCHECK_LE(x, y) \
  while (false) TVM_FFI_CHECK_LE_IMPL(x, y, InternalError)
#define DCHECK_GE(x, y) \
  while (false) TVM_FFI_CHECK_GE_IMPL(x, y, InternalError)
#define DCHECK_EQ(x, y) \
  while (false) TVM_FFI_CHECK_EQ_IMPL(x, y, InternalError)
#define DCHECK_NE(x, y) \
  while (false) TVM_FFI_CHECK_NE_IMPL(x, y, InternalError)
