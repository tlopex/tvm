...
void CollectReindexCacheStageInfoAndCreateBuffer(
  ...
  ffi::Array<PrimExpr> new_indices = index_map->MapIndices(block_iter_vars, analyzer.get());
  ffi::Array<PrimExpr> new_shape = index_map->MapShape(block_shape, analyzer.get());
