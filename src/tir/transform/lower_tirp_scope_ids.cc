...
/*!
 * \file lower_tirp_scope_ids.cc
 * \brief Resolve scope id definitions for TIRp lowering.
 */
...
Pass LowerTIRpResolveScopeIds() {
  ...
  return CreatePrimFuncPass(pass_func, 0, "tir.LowerTIRpResolveScopeIds", {});
}
