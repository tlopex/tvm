...
def test_hgemm_rs():
    ...
    def test_mma_ss_tma_2sm_persistent(A: T.Buffer((M, K), a_type, layout="default"), B: T.Buffer((N, K), b_type, layout="default"), gemm_out: T.Buffer((M, N), d_type, layout="default"),
                                       semaphore: T.Buffer((LOCAL_M // TILE_M, N // TILE_N), "uint64", layout="default"), out: T.Buffer((LOCAL_M, N), d_type, layout="default"), profiler_buffer: T.Buffer((PROFILER_BUFFER_SIZE,), "uint64"),
                                       ...
                                       rs_task_types: T.Buffer((CAPACITY,), "int32", layout="default"), rs_task_idxs: T.Buffer((CAPACITY, 2), "int32", layout="default"), rs_head: T.Buffer((1,), "int32", layout="default"), rs_tail: T.Buffer((1,), "int32", layout="default")):
