...
class MegaKernel:
    ...
    def get_func_static(self):
        ...
        def main(
            ...
            gemm_gate_up_proj_tile = T.meta_var(GemmTile(INTERMEDIATE_SIZE * 2, HIDDEN_SIZE, "float16", "float16", "float16", 1, prefetch_on=True))
...
def test(batch_size, mega_kernel_static, mega_kernel_dynamic):
    ...
    def prepare_data(batch_size):
        ...
        arg_dict["down_weight"] = torch.zeros((HIDDEN_SIZE, INTERMEDIATE_SIZE), dtype=torch.float16)
    ...
    def std(arg_dict, use_prefill):
        ...
        def func():
            ...
            out_f = torch.zeros(
                batch_size, NUM_ATTENTION_HEADS, HEAD_DIM, dtype=torch.float16, device="cuda"
            )
            ...
            if use_prefill:
                ...
                wrapper.run(
                    q.reshape(batch_size, NUM_ATTENTION_HEADS, HEAD_DIM),
