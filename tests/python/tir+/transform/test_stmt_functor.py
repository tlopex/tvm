...
def test_seq_stmt():
    ...
    basic_check(
        ...
        "\n".join(["Var", "IntImm", "Add", "Evaluate", "IntImm", "IntImm", "Var", "IntImm", "Add", "Evaluate", "For", "SeqStmt"]),
    )
...
def test_block_realize():
    ...
    basic_check(
        ...
        "\n".join(["IntImm", "IntImm", "IntImm", "IntImm", "Var", "IntImm", "Add", "Evaluate", "Block", "BlockRealize"]),
    )
...
def test_if_then_else():
    ...
    basic_check(
        ...
        "\n".join(["Var", "IntImm", "LT", "Var", "IntImm", "Add", "Evaluate", "Var", "IntImm", "Add", "Evaluate", "IfThenElse"]),
    )
