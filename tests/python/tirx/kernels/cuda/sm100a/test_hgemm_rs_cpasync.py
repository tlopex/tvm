...
class ReduceScatter:
    ...
    def reduce_sum(
        ...
        src_tensor_map: Tx.handle("tensormap") = Tx.tvm_stack_alloca("tensormap", 1)
        dst_tensor_map: Tx.handle("tensormap") = Tx.tvm_stack_alloca("tensormap", 1)
        Tx.call_packed(
