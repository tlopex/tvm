...
def get_qwen3_megakernel_mod():
    ...
    fused_split_silu_multiply = get_fused_split_silu_multiply_kernel_cp_async(25600)
    ...
    class Module:
        ...
        def split(var_reshape: Tx.handle, var_T_split: Tx.handle, var_T_split_1: Tx.handle, var_T_split_2: Tx.handle):  # noqa: E501
            ...
            batch_size = Tx.int64()
            reshape = Tx.match_buffer(var_reshape, (batch_size, Tx.int64(1), Tx.int64(80), Tx.int64(128)), "float16")  # noqa: E501
            T_split = Tx.match_buffer(var_T_split, (batch_size, Tx.int64(1), Tx.int64(64), Tx.int64(128)), "float16")  # noqa: E501
            T_split_1 = Tx.match_buffer(var_T_split_1, (batch_size, Tx.int64(1), Tx.int64(8), Tx.int64(128)), "float16")  # noqa: E501
            T_split_2 = Tx.match_buffer(var_T_split_2, (batch_size, Tx.int64(1), Tx.int64(8), Tx.int64(128)), "float16")  # noqa: E501
            # with Tx.sblock("root"):
        ...
        def fused_concatenate(p_split_2: Tx.handle, p_rms_norm1: Tx.handle, p_rms_norm2: Tx.handle, p_output0: Tx.handle):  # noqa: E501
            Tx.func_attr({"tir.noalias": True})
            batch_size = Tx.int64()
            split_2 = Tx.match_buffer(p_split_2, (batch_size, Tx.int64(1), Tx.int64(8), Tx.int64(128)), "float16")  # noqa: E501
            rms_norm1 = Tx.match_buffer(p_rms_norm1, (batch_size, Tx.int64(1), Tx.int64(64), Tx.int64(128)), "float16")  # noqa: E501
            rms_norm2 = Tx.match_buffer(p_rms_norm2, (batch_size, Tx.int64(1), Tx.int64(8), Tx.int64(128)), "float16")  # noqa: E501
            ...
            for ax0, ax1, ax2, ax3 in Tx.grid(batch_size, Tx.int64(1), Tx.int64(80), Tx.int64(128)):
                with Tx.sblock("T_concat"):
                    v_ax0, v_ax1, v_ax2, v_ax3 = Tx.axis.remap("SSSS", [ax0, ax1, ax2, ax3])
                    Tx.reads(split_2[v_ax0, v_ax1, v_ax2 - Tx.int64(72), v_ax3], rms_norm2[v_ax0, v_ax1, v_ax2 - Tx.int64(64), v_ax3], rms_norm1[v_ax0, v_ax1, v_ax2, v_ax3])  # noqa: E501
                    Tx.writes(T_concat_intermediate[v_ax0, v_ax1, v_ax2, v_ax3])
                    T_concat_intermediate[v_ax0, v_ax1, v_ax2, v_ax3] = Tx.if_then_else(Tx.int64(72) <= v_ax2, split_2[v_ax0, v_ax1, v_ax2 - Tx.int64(72), v_ax3], Tx.if_then_else(Tx.int64(64) <= v_ax2, rms_norm2[v_ax0, v_ax1, v_ax2 - Tx.int64(64), v_ax3], rms_norm1[v_ax0, v_ax1, v_ax2, v_ax3]))  # noqa: E501
        ...
        def cos_sin_cache_func(cache: R.Tensor((MAX_SEQ_LEN, 128), dtype="float32")):
            cls = Module
            with R.dataflow():
                cache: R.Tensor((MAX_SEQ_LEN, 128), dtype="float32") = R.call_tir_inplace(cls.cos_sin_cache, (cache), [0], out_sinfo=R.Tensor((MAX_SEQ_LEN, 128), dtype="float32") )  # noqa: E501
                R.output(cache)
            return cache
        ...
        def batch_decode(
            ...
            with R.dataflow():
                ...
                kv_data_, kv_indptr, kv_indices_, kv_last_page_len, append_position_map, q_rope_position_map = (  # noqa: E501
                    res0[0],
                    res0[1],
                    res0[3],
                    res0[4],
                ...
                kv_data = R.match_cast(kv_data_, R.Tuple([R.Tensor((max_page_num, 2, 8, page_size, 128), dtype="float16")]))  # noqa: E501
                ...
                plan_lse_tvm_, plan_request_indices_, plan_kv_tile_indices_, plan_max_chunk_size = res1[0], res1[1], res1[2], res1[3]  # noqa: E501
                plan_lse_tvm = R.match_cast(plan_lse_tvm_, R.Tensor((new_batch_size, 64), dtype="float32"))  # noqa: E501
                plan_request_indices = R.match_cast(plan_request_indices_, R.Tensor((new_batch_size,), dtype="int32"))  # noqa: E501
                plan_kv_tile_indices = R.match_cast(plan_kv_tile_indices_, R.Tensor((new_batch_size,), dtype="int32"))  # noqa: E501

                model_layers_0_self_attn_c_attn_weight1: R.Tensor((10240, 5120), dtype="float16") = packed_params[1]  # noqa: E501
                model_layers_0_self_attn_o_proj_weight1: R.Tensor((5120, 8192), dtype="float16") = packed_params[2]  # noqa: E501
                model_layers_0_self_attn_q_norm_weight1: R.Tensor((128,), dtype="float16") = packed_params[3]  # noqa: E501
                model_layers_0_self_attn_k_norm_weight1: R.Tensor((128,), dtype="float16") = packed_params[4]  # noqa: E501
                model_layers_0_mlp_gate_up_proj_weight1: R.Tensor((51200, 5120), dtype="float16") = packed_params[5]  # noqa: E501
                model_layers_0_mlp_down_proj_weight1: R.Tensor((5120, 25600), dtype="float16") = packed_params[6]  # noqa: E501
                model_layers_0_input_layernorm_weight1: R.Tensor((5120,), dtype="float16") = packed_params[7]  # noqa: E501
                model_layers_0_post_attention_layernorm_weight1: R.Tensor((5120,), dtype="float16") = packed_params[8]  # noqa: E501
                ...
                ps0 = R.call_tir(cls.hgemm1, (rms_norm, model_layers_0_self_attn_c_attn_weight1), out_sinfo=R.Tensor((tile_k_num1, batch_size, 10240), dtype="float32"))  # noqa: E501
                lv = R.call_tir(cls.reduce1, (ps0,), out_sinfo=R.Tensor((batch_size, 10240), dtype="float16"))  # noqa: E501

                reshape = R.reshape(lv, (batch_size, 1, 80, 128))
                split = R.call_tir(cls.split, (reshape,), out_sinfo=[R.Tensor((batch_size, 1, 64, 128), dtype="float16"), R.Tensor((batch_size, 1, 8, 128), dtype="float16"), R.Tensor((batch_size, 1, 8, 128), dtype="float16")])  # noqa: E501
                ...
                rms_norm1 = R.call_tir(cls.rms_norm1, (rs1, model_layers_0_self_attn_q_norm_weight1), out_sinfo=R.Tensor((batch_size * 64, 128), dtype="float16"))  # noqa: E501
                rms_norm2 = R.call_tir(cls.rms_norm1, (rs2, model_layers_0_self_attn_k_norm_weight1), out_sinfo=R.Tensor((batch_size * 8, 128), dtype="float16"))  # noqa: E501
                ...
                ######################################################### Attention #########################################################  # noqa: E501
                #########################################################
                # lv1 = R.call_tir(cls.fused_concatenate, (v, rms_norm1_rs, rms_norm2_rs), out_sinfo=R.Tensor((batch_size, 1, 80, 128), dtype="float16"))  # noqa: E501
                # reshape1 = R.reshape(lv1, (batch_size, 80, 128))
                # lv_2 = R.call_dps_packed("vm.builtin.attention_kv_cache_attention_with_fused_qkv", (paged_kv_cache, R.prim_value(0), R.prim_value(Tx.float32(0.088388347648318447)), reshape1), out_sinfo=R.Tensor((batch_size, 64, 128), dtype="float16"))  # noqa: E501
                ...
                q_rope = R.call_tir(cls.rope, (q_rs, cos_sin_cache, q_rope_position_map), out_sinfo=R.Tensor((batch_size, 64, 128), dtype="float16"))  # noqa: E501
                k_rs = R.reshape(rms_norm2_rs, (batch_size, 8, 128))
                k = R.call_tir(cls.rope, (k_rs, cos_sin_cache, q_rope_position_map), out_sinfo=R.Tensor((batch_size, 8, 128), dtype="float16"))  # noqa: E501
                k_rope = R.reshape(k, (batch_size, 1, 8, 128))
                # append
                append_position_map_rs = R.reshape(append_position_map, (batch_size, 1))
                new_kv_data = R.call_tir_inplace(cls.append_paged_kv_cache, (kv_data[0], k_rope, v, append_position_map_rs), [0],  # noqa: E501
                                                 out_sinfo=R.Tensor((max_page_num, 2, 8, page_size, 128), dtype="float16"))  # noqa: E501
                # attention
                o = R.call_tir(cls.decode,
                               (q_rope, new_kv_data, plan_lse_tvm, kv_indptr, kv_last_page_len, kv_indices, plan_request_indices, plan_kv_tile_indices, plan_max_chunk_size), out_sinfo=R.Tensor((batch_size, 64, 128), dtype="float16"))  # noqa: E501
                ...
                rs1 = R.call_tir(cls.hgemm2, (reshape3, model_layers_0_self_attn_o_proj_weight1), out_sinfo=R.Tensor((tile_k_num2, batch_size, 5120), dtype="float32"))  # noqa: E501
                lv1_1 = R.call_tir(cls.reduce2, (rs1,), out_sinfo=R.Tensor((batch_size, 5120), dtype="float16"))  # noqa: E501

                lv_3 = R.call_tir_inplace(cls.fused_add_rmsnorm, (lv1_1, rs0, model_layers_0_post_attention_layernorm_weight1), [0, 1], out_sinfo=[R.Tensor((batch_size, 5120), dtype="float16"), R.Tensor((batch_size, 5120), dtype="float16")])  # noqa: E501
                ...
                # lv2: R.Tensor((batch_size, 51200), dtype="float16") = R.matmul(rms_norm3, permute_dims2, out_dtype="void")  # noqa: E501
                rs2 = R.call_tir(cls.hgemm3, (rms_norm3, model_layers_0_mlp_gate_up_proj_weight1), out_sinfo=R.Tensor((tile_k_num3, batch_size, 51200), dtype="float32"))  # noqa: E501
                lv2 = R.call_tir(cls.reduce3, (rs2,), out_sinfo=R.Tensor((batch_size, 51200), dtype="float16"))  # noqa: E501

                lv2_1 = R.call_tir(cls.fused_split_silu_multiply, (lv2,), out_sinfo=R.Tensor((batch_size, 25600), dtype="float16"))  # noqa: E501
                ...
                rs3 = R.call_tir(cls.hgemm4, (lv2_1, model_layers_0_mlp_down_proj_weight1), out_sinfo=R.Tensor((tile_k_num4, batch_size, 5120), dtype="float32"))  # noqa: E501
                lv3 = R.call_tir(cls.reduce4, (rs3,), out_sinfo=R.Tensor((batch_size, 5120), dtype="float16"))  # noqa: E501

                lv2_2 = R.call_tir_inplace(cls.fused_add_rmsnorm, (lv3, lv1_2, model_norm_weight1), [0, 1], out_sinfo=[R.Tensor((batch_size, 5120), dtype="float16"), R.Tensor((batch_size, 5120), dtype="float16")])  # noqa: E501
                ...
                rs4 = R.call_tir(cls.hgemm5, (rms_norm4, lm_head_weight1), out_sinfo=R.Tensor((tile_k_num5, batch_size, 151936), dtype="float32"))  # noqa: E501
...
class Module2:
    ...
    def batch_decode(input_embeds: R.Tensor(("batch_size", 1, 5120), dtype="float16"), paged_kv_cache: R.Object, packed_params: R.Tuple(R.Tensor((151936, 5120), dtype="float16"), R.Tensor((10240, 5120), dtype="float16"), R.Tensor((5120, 8192), dtype="float16"), R.Tensor((128,), dtype="float16"), R.Tensor((128,), dtype="float16"), R.Tensor((51200, 5120), dtype="float16"), R.Tensor((5120, 25600), dtype="float16"), R.Tensor((5120,), dtype="float16"), R.Tensor((5120,), dtype="float16"), R.Tensor((5120,), dtype="float16"), R.Tensor((151936, 5120), dtype="float16"))) -> R.Tuple(R.Tensor(("batch_size", 1, 151936), dtype="float32"), R.Object):  # noqa: E501
        ...
        with R.dataflow():
            ...
            model_norm_weight1: R.Tensor((5120,), dtype="float16") = packed_params[9]
            lm_head_weight1: R.Tensor((151936, 5120), dtype="float16") = packed_params[10]
            rms_norm: R.Tensor((batch_size, 1, 5120), dtype="float16") = R.nn.rms_norm(input_embeds, model_layers_0_input_layernorm_weight1, axes=[-1], epsilon=9.9999999999999995e-07)  # noqa: E501
            permute_dims: R.Tensor((5120, 10240), dtype="float16") = R.permute_dims(model_layers_0_self_attn_c_attn_weight1, axes=None)  # noqa: E501
            matmul: R.Tensor((batch_size, 1, 10240), dtype="float16") = R.matmul(rms_norm, permute_dims, out_dtype="void")  # noqa: E501
            reshape: R.Tensor((batch_size, 1, 80, 128), dtype="float16") = R.reshape(matmul, R.shape([batch_size, 1, 80, 128]))  # noqa: E501
            split: R.Tuple(R.Tensor((batch_size, 1, 64, 128), dtype="float16"), R.Tensor((batch_size, 1, 8, 128), dtype="float16"), R.Tensor((batch_size, 1, 8, 128), dtype="float16")) = R.split(reshape, indices_or_sections=[64, 72], axis=2)  # noqa: E501
            split_0: R.Tensor((batch_size, 1, 64, 128), dtype="float16") = split[0]
            split_1: R.Tensor((batch_size, 1, 8, 128), dtype="float16") = split[1]
            split_2: R.Tensor((batch_size, 1, 8, 128), dtype="float16") = split[2]
            rms_norm1: R.Tensor((batch_size, 1, 64, 128), dtype="float16") = R.nn.rms_norm(split_0, model_layers_0_self_attn_q_norm_weight1, axes=[-1], epsilon=9.9999999999999995e-07)  # noqa: E501
            rms_norm2: R.Tensor((batch_size, 1, 8, 128), dtype="float16") = R.nn.rms_norm(split_1, model_layers_0_self_attn_k_norm_weight1, axes=[-1], epsilon=9.9999999999999995e-07)  # noqa: E501
            concat: R.Tensor((batch_size, 1, 80, 128), dtype="float16") = R.concat((rms_norm1, rms_norm2, split_2), axis=2)  # noqa: E501
            reshape1: R.Tensor((batch_size, 80, 128), dtype="float16") = R.reshape(concat, R.shape([batch_size, 80, 128]))  # noqa: E501
            lv = R.call_dps_packed("vm.builtin.attention_kv_cache_attention_with_fused_qkv", (paged_kv_cache, R.prim_value(0), R.prim_value(Tx.float32(0.088388347648318447)), reshape1), out_sinfo=R.Tensor((batch_size, 64, 128), dtype="float16"))  # noqa: E501
            reshape2: R.Tensor((batch_size, 1, 64, 128), dtype="float16") = R.reshape(lv, R.shape([batch_size, 1, 64, 128]))  # noqa: E501
            reshape3: R.Tensor((batch_size, 1, 8192), dtype="float16") = R.reshape(reshape2, R.shape([batch_size, 1, 8192]))  # noqa: E501
            permute_dims1: R.Tensor((8192, 5120), dtype="float16") = R.permute_dims(model_layers_0_self_attn_o_proj_weight1, axes=None)  # noqa: E501
            matmul1: R.Tensor((batch_size, 1, 5120), dtype="float16") = R.matmul(reshape3, permute_dims1, out_dtype="void")  # noqa: E501
            add: R.Tensor((batch_size, 1, 5120), dtype="float16") = R.add(matmul1, input_embeds)
            rms_norm3: R.Tensor((batch_size, 1, 5120), dtype="float16") = R.nn.rms_norm(add, model_layers_0_post_attention_layernorm_weight1, axes=[-1], epsilon=9.9999999999999995e-07)  # noqa: E501
            permute_dims2: R.Tensor((5120, 51200), dtype="float16") = R.permute_dims(model_layers_0_mlp_gate_up_proj_weight1, axes=None)  # noqa: E501
            matmul2: R.Tensor((batch_size, 1, 51200), dtype="float16") = R.matmul(rms_norm3, permute_dims2, out_dtype="void")  # noqa: E501
            split1: R.Tuple(R.Tensor((batch_size, 1, 25600), dtype="float16"), R.Tensor((batch_size, 1, 25600), dtype="float16")) = R.split(matmul2, indices_or_sections=2, axis=-1)  # noqa: E501
            ...
            permute_dims3: R.Tensor((25600, 5120), dtype="float16") = R.permute_dims(model_layers_0_mlp_down_proj_weight1, axes=None)  # noqa: E501
            matmul3: R.Tensor((batch_size, 1, 5120), dtype="float16") = R.matmul(mul, permute_dims3, out_dtype="void")  # noqa: E501
            add1: R.Tensor((batch_size, 1, 5120), dtype="float16") = R.add(matmul3, add)
            rms_norm4: R.Tensor((batch_size, 1, 5120), dtype="float16") = R.nn.rms_norm(add1, model_norm_weight1, axes=[-1], epsilon=9.9999999999999995e-07)  # noqa: E501
            permute_dims4: R.Tensor((5120, 151936), dtype="float16") = R.permute_dims(lm_head_weight1, axes=None)  # noqa: E501
            matmul4: R.Tensor((batch_size, 1, 151936), dtype="float16") = R.matmul(rms_norm4, permute_dims4, out_dtype="void")  # noqa: E501
            astype: R.Tensor((batch_size, 1, 151936), dtype="float32") = R.astype(matmul4, dtype="float32")  # noqa: E501
            gv1: R.Tuple(R.Tensor((batch_size, 1, 151936), dtype="float32"), R.Object) = astype, paged_kv_cache  # noqa: E501
            R.output(gv1)
        return gv1
# fmt: on
