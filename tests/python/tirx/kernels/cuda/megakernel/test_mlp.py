...
from tvm.tirx.megakernel.add_rmsnorm import AddRMSNormTile
...
from tvm.tirx.megakernel.static_scheduler import StaticTileScheduler
...
class MegaKernel:
    ...
    def get_static_scheduler_func(self):
        from tvm.tirx.megakernel.static_scheduler import Semaphore
    ...
    def get_dynamic_scheduler_func(self):
        from tvm.tirx.megakernel.dynamic_scheduler import Semaphore
