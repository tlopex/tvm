...
def test_gemm2(ssh_client):
    ...
    def matmul2(A_ptr: T.handle, B_ptr: T.handle, C_ptr: T.handle):
        ...
        T.device_entry()
        result_tiles = T.alloc_buffer((2, BLOCK_M, BLOCK_N), "float32", scope="trn.sbuf", layout="FPF")  # noqa: E501
        ...
        c_psum = T.alloc_buffer((8, TILE_M, TILE_N), "float32", scope="trn.psum", layout="FPF", allocated_addr=(0, 0))  # noqa: E501
        load_A(0, a_sbuf, A)
        load_B(0, b_sbuf, B)
