...
def test_copy_in_a_loop_2():
    ...
    def expected(A_ptr: Tx.handle):
        ...
        A_sbuf = Tx.alloc_buffer((128, 2048), scope="trn.sbuf")
        A_sbuf_view = Tx.decl_buffer((128, 2048), data=A_sbuf.data, scope="trn.sbuf", layout=None)
...
def test_copy_different_shape():
    ...
    def expected():
        ...
        _B_sbuf_view = Tx.decl_buffer((128, 16), data=B_sbuf.data, scope="trn.sbuf", layout=None)
