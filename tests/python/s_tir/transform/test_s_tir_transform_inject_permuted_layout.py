                                    ...
                                    with T.sblock(""):
                                        ...
                                        for ax0_0, ax1_0 in T.grid(2, 1):
                                            with T.sblock("X_reindex_shared.dyn_m16n8k8.matrixA_o"):
                                                ...
                                                T.ptx.ldmatrix("float16", T.bool(False), 4, ".b16", X_reindex_shared_dyn_m16n8k8_matrixA.data, ax0_0 * 8, T.tvm_access_ptr(T.type_annotation("float16"), X_reindex_shared_dyn.data, threadIdx_y // 2 * 2048 + ax0_0 * 1024 + ax2_0_1 * 8, 1024, 1), threadIdx_x * 32)
                                    ...
                                    with T.sblock(""):
                                        ...
                                        for ax0_0, ax1_0 in T.grid(2, 1):
                                            with T.sblock("X_reindex_shared.dyn_m16n8k8.matrixA_o"):
                                                T.reads(X_reindex_shared_dyn[threadIdx_y // 2 * 64 + ax0_0 * 32:threadIdx_y // 2 * 64 + ax0_0 * 32 + 32, ax2_0_1 * 8:ax2_0_1 * 8 + 8])
                                                T.writes(X_reindex_shared_dyn_m16n8k8_matrixA[ax0_0 * 32:ax0_0 * 32 + 32, 0:8])
                                                T.ptx.ldmatrix("float16", T.bool(False), 4, ".b16", X_reindex_shared_dyn_m16n8k8_matrixA.data, ax0_0 * 8, T.tvm_access_ptr(T.type_annotation("float16"), X_reindex_shared_dyn.data, threadIdx_y // 2 * 2048 + ax0_0 * 1024 + threadIdx_x * 32 + T.bitwise_xor(ax2_0_1, threadIdx_x % 8 // 2) * 8, 1024, 1), 0)
    # fmt: on
                                        ...
                                        with T.sblock(""):
                                            ...
                                            for ax0_0, ax1_0 in T.grid(1, 2):
                                                with T.sblock("Y_reindex_shared.dyn_m16n8k8.matrixB_o"):
                                                    ...
                                                    T.ptx.ldmatrix("float16", T.bool(True), 4, ".b16", Y_reindex_shared_dyn_m16n8k8_matrixB.data, ax1_0 * 8, T.tvm_access_ptr(T.type_annotation("float16"), Y_reindex_shared_dyn.data, ax2_0_1 * 1024 + threadIdx_y % 2 * 64 + ax1_0 * 32, 1024, 1), threadIdx_x % 8 * 128 + threadIdx_x // 8 * 8)
                                        ...
                                        with T.sblock(""):
                                            ...
                                            for ax0_0, ax1_0 in T.grid(1, 2):
                                                with T.sblock("Y_reindex_shared.dyn_m16n8k8.matrixB_o"):
                                                    T.reads(Y_reindex_shared_dyn[ax2_0_1 * 8:ax2_0_1 * 8 + 8, threadIdx_y % 2 * 64 + ax1_0 * 32:threadIdx_y % 2 * 64 + ax1_0 * 32 + 32])
                                                    T.writes(Y_reindex_shared_dyn_m16n8k8_matrixB[0:8, ax1_0 * 32:ax1_0 * 32 + 32])
                                                    T.ptx.ldmatrix("float16", T.bool(True), 4, ".b16", Y_reindex_shared_dyn_m16n8k8_matrixB.data, ax1_0 * 8, T.tvm_access_ptr(T.type_annotation("float16"), Y_reindex_shared_dyn.data, ax2_0_1 * 1024 + threadIdx_x % 8 * 128 + T.bitwise_xor(threadIdx_y % 2 * 8 + ax1_0 * 4 + threadIdx_x // 8, threadIdx_x % 8) * 8, 1024, 1), 0)
    # fmt: on
    _check_primfunc_transform(before, expected)
                    ...
                    for v0, v1 in T.grid(T.int64(2), T.int64(4)):
                        with T.sblock("A_reindex_shared.dyn_warp_o"):
                            ...
                            with T.sblock("A_reindex_shared.dyn_warp_o"):
                                ...
                                T.ptx.ldmatrix("float16", T.bool(False), 4, ".b16",
                                    A_warp.data,
                    ...
                    for v0, v1 in T.grid(T.int64(2), T.int64(4)):
                        with T.sblock("A_reindex_shared.dyn_warp_o"):
                            ...
                            with T.sblock("A_reindex_shared.dyn_warp_o"):
                                T.reads(A_shared_dyn[threadIdx_z * T.int64(64) + v1 * T.int64(16):threadIdx_z * T.int64(64) + v1 * T.int64(16) + T.int64(16), v0 * T.int64(16):v0 * T.int64(16) + T.int64(16)])
                                T.writes(A_warp[v1, T.int64(0), T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                T.ptx.ldmatrix("float16", T.bool(False), 4, ".b16", A_warp.data, v1 * T.int64(256) + threadIdx_x * T.int64(8), T.tvm_access_ptr(T.type_annotation("float16"), A_shared_dyn.data, threadIdx_z * T.int64(2048) + v1 * T.int64(512) + threadIdx_x % T.int64(16) * T.int64(32) + T.bitwise_xor(v0 * T.int64(2) + threadIdx_x // T.int64(16), threadIdx_x % T.int64(8) // T.int64(2)) * T.int64(8), T.int64(512), 1), T.int64(0))
